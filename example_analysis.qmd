...
![](images/rainfall_temp.jpeg)[@newsarticle]
...
Any environmental specialists who are interested in exploring the relationship between temperature and rainfall, and use the relationship to predict possible health impact on the population.

## Methods

### Load original data

The two datasets I will be using comes from [TidyTuesday](https://www.tidytuesday.com). Specifically, I will use the following data from January 2020.
